export const PENANG_BLOG_POST = [
  ...
  },
  {
    ...
    description:
      "Penang Hill offers a refreshing escape from the island's tropical heat, providing panoramic views, cooler temperatures, and a serene atmosphere. Accessible via one of the world's oldest funicular railways, the hilltop is home to colonial-era architecture, nature trails, and top attractions like The Habitat and the Skywalk. It's perfect for nature lovers, couples, and families seeking a peaceful retreat amidst lush greenery. At 833 meters above sea level, the cooler climate and breathtaking vistas make it a must-visit destination. Sunset visits offer especially stunning photo opportunities.",
  ...
  },
  {
    ...
    image: "/images/country/malaysia/places/penang/blog/kl_tower.jpg",
    description:
  ...
  {
    id: 6,
    name: "Blue Mansion (Cheong Fatt Tze Mansion)",
  ...
  },
  {
    ...
    image:
      "/images/country/malaysia/places/penang/blog/penang_butterfly_park.jpg",
    description:
