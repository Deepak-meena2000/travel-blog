...
export const MALAYSIA_COMPLETE_FOOD_GUIDE = [
  {
    ...
    description: "Start your day with Malaysia's most beloved breakfast dishes, from fragrant rice dishes to flaky flatbreads.",
    items: [
      {
        id: 1,
        name: "Nasi Lemak",
        description: "Nasi Lemak is Malaysia's iconic breakfast dish, beloved across all ethnicities. It features fragrant coconut milk rice served with spicy sambal, crispy anchovies, toasted peanuts, cucumber slices, and a hard-boiled or fried egg. Often accompanied by fried chicken or rendang, it's a satisfying, flavorful meal that fuels locals for the day ahead.",
        image: "/placeholder.svg?height=300&width=500"
      },
      {
        id: 2,
        name: "Roti Canai",
        description: "Roti Canai is a flaky, crispy Indian-style flatbread that's a staple Malaysian breakfast, particularly in mamak stalls. Made by flipping and stretching dough until it's thin, then pan-frying until golden, it's typically served with dhal (lentil curry) or meat curries like chicken or beef.",
        image: "/placeholder.svg?height=300&width=500"
      },
      {
        id: 3,
        name: "Kaya Toast & Soft-Boiled Eggs",
        description: "Kaya Toast and Soft-Boiled Eggs offer a simple yet comforting breakfast loved throughout Malaysia and Singapore. The toast is slathered with kaya, a sweet coconut and egg jam, and a generous slab of butter. It's paired with two soft-boiled eggs seasoned with light soy sauce and white pepper.",
        image: "/placeholder.svg?height=300&width=500"
      },
      {
        id: 4,
        name: "Chee Cheong Fun",
        description: "Chee Cheong Fun is a classic Chinese-Malaysian breakfast made of silky, steamed rice noodle rolls. Served plain or filled with shrimp, char siu, or minced meat, it's topped with sweet soy sauce, chili sauce, sesame seeds, and sometimes fried shallots.",
        image: "/placeholder.svg?height=300&width=500"
      },
      {
        id: 5,
        name: "Nasi Dagang",
        description: "Nasi Dagang is a beloved East Coast Malaysian breakfast, especially in Kelantan and Terengganu. It features aromatic rice steamed in coconut milk and fenugreek seeds, served with rich tuna curry, pickled vegetables (acar), and boiled eggs.",
        image: "/placeholder.svg?height=300&width=500"
      },
      {
        id: 6,
        name: "Nasi Tumpang",
        description: "Nasi Tumpang is a unique Kelantanese breakfast wrapped in a conical banana leaf package. Traditionally prepared for travelers, this layered rice dish includes white rice alternated with ingredients like chicken or fish curry, sambal, beef floss (serunding), and omelet.",
        image: "/placeholder.svg?height=300&width=500"
      }
    ]
  },
  {
    ...
    description: "Discover Malaysia's most popular main dishes, perfect for lunch or dinner.",
    items: [
      {
        id: 7,
        name: "Char Kway Teow",
        description: "Char Kway Teow is a beloved Malaysian stir-fried noodle dish, perfect for lunch or dinner. Made with flat rice noodles, it's tossed over high heat with prawns, Chinese sausage, bean sprouts, eggs, and chives in a savory dark soy sauce.",
        image: "/placeholder.svg?height=300&width=500"
      },
      {
        id: 8,
        name: "Laksa",
        description: "Laksa is a spicy noodle soup with rich regional variations across Malaysia. The two most popular types are Curry Laksa, a coconut-based broth with egg noodles, tofu puffs, chicken, and shrimp, and Asam Laksa, a tangy fish-based soup with tamarind and mackerel.",
        image: "/placeholder.svg?height=300&width=500"
      },
      {
        id: 9,
        name: "Nasi Kandar",
        description: "Nasi Kandar is a northern Malaysian specialty from Penang, popular for lunch or dinner. It features steamed rice served with an array of flavorful curries, gravies, and side dishes like fried chicken, beef rendang, okra, boiled eggs, and more.",
        image: "/placeholder.svg?height=300&width=500"
      },
      {
        id: 10,
        name: "Mee Goreng Mamak",
        description: "Mee Goreng Mamak is a spicy, tangy fried noodle dish commonly eaten for lunch or dinner. Yellow noodles are wok-fried with tofu, potatoes, bean sprouts, eggs, and sometimes seafood or chicken, flavored with soy sauce, tomato ketchup, and chili paste.",
        image: "/placeholder.svg?height=300&width=500"
      },
      {
        id: 11,
        name: "Rendang",
        description: "Rendang is a slow-cooked dry curry originating from the Minangkabau culture, and it's a staple in Malaysian and Indonesian cuisine. Typically made with beef, it's simmered for hours in coconut milk and a fragrant blend of lemongrass, galangal, garlic, ginger, and chili until tender and richly caramelized.",
        image: "/placeholder.svg?height=300&width=500"
      },
      {
        id: 12,
        name: "Hainanese Chicken Rice",
        description: "Hainanese Chicken Rice is a simple yet beloved dish that pairs poached or roasted chicken with fragrant rice cooked in chicken broth and garlic. Served with chili sauce, ginger paste, and soy sauce, it's light yet flavorful.",
        image: "/placeholder.svg?height=300&width=500"
      },
      {
        id: 13,
        name: "Ikan Bakar",
        description: "Ikan Bakar, or grilled fish, is a smoky and spicy seafood dish perfect for lunch or dinner by the beach or at a night market. Fresh whole fish like stingray or mackerel is marinated with turmeric, chili paste, and spices, then wrapped in banana leaves and grilled over charcoal.",
        image: "/placeholder.svg?height=300&width=500"
      },
      {
        id: 14,
        name: "Nasi Campur",
        description: "Nasi Campur, or 'mixed rice,' is a highly customizable Malaysian meal where you pick a portion of rice and choose from a variety of sides like curries, stir-fried vegetables, fried chicken, sambal, eggs, tofu, and more.",
        image: "/placeholder.svg?height=300&width=500"
      },
      {
        id: 15,
        name: "Nasi Dalca",
        description: "Nasi Dalca is a flavorful Malaysian-Indian dish combining spiced rice with dalca, a thick mildly spiced lentil and vegetable curry. The rice is often cooked with aromatic spices and served with additional curries, pickles, and fried chicken or beef.",
        image: "/placeholder.svg?height=300&width=500"
      }
    ]
  },
  {
    id: "street-food",
    title: "Street Food",
    description: "Experience Malaysia's vibrant street food scene with these popular snacks and quick bites.",
    items: [
      {
        id: 16,
        name: "Satay",
        description: "Satay is one of Malaysia's most iconic street foods, skewers of marinated meat (usually chicken or beef) grilled over open flames and served with a rich peanut sauce, cucumber, onions, and compressed rice cakes (ketupat).",
        image: "/placeholder.svg?height=300&width=500"
      },
      {
        id: 17,
        name: "Rojak",
        description: "Rojak is a bold, tangy Malaysian fruit and vegetable salad that's a true flavor bomb. Commonly made with cucumber, jicama, pineapple, tofu puffs, and dough fritters, it's tossed in a thick shrimp paste sauce blended with sugar, chili, and lime.",
        image: "/placeholder.svg?height=300&width=500"
      },
      {
        id: 18,
        name: "Roti John",
        description: "Roti John is a uniquely Malaysian street food sandwich, especially popular in night markets and pasar malam. It features a baguette-like bun filled with minced meat (chicken or beef), egg, onions, and sometimes sardines, all fried on a hot griddle.",
        image: "/placeholder.svg?height=300&width=500"
      },
      {
        id: 19,
        name: "Murtabak",
        description: "Murtabak is a thick, stuffed pan-fried flatbread that's popular across Malaysia, especially during Ramadan and at night bazaars. It's filled with spiced minced meat (usually beef or chicken), eggs, and onions, folded in a thin dough, and griddled until golden brown.",
        image: "/placeholder.svg?height=300&width=500"
      },
      {
        id: 20,
        name: "Roti Tisu",
        description: "Roti Tisu, or 'tissue bread,' is a paper-thin, crispy version of roti canai, stretched into a tall cone or large triangle and caramelized with sugar, butter, or sweetened condensed milk.",
        image: "/placeholder.svg?height=300&width=500"
      }
    ]
  },
  {
    ...
    description: "Discover delicious vegetarian dishes across Malaysia's diverse culinary landscape.",
    items: [
      {
        id: 21,
        name: "Banana Leaf Rice",
        description: "Banana Leaf Rice is a traditional South Indian vegetarian meal widely available in Malaysian Indian restaurants. Served on a banana leaf, it typically includes white or parboiled rice, various vegetable curries, pickles, papadum, and dhal.",
        image: "/placeholder.svg?height=300&width=500"
      },
      {
        id: 22,
        name: "Vegetarian Mee Goreng",
        description: "Mee Goreng can easily be made vegetarian and is widely available at Indian-Muslim (mamak) eateries and vegetarian stalls. Made with yellow noodles stir-fried in a mix of soy sauce, ketchup, and chili, it's tossed with tofu, cabbage, bean sprouts, and sometimes potatoes or tomatoes.",
        image: "/placeholder.svg?height=300&width=500"
      },
      {
        id: 23,
        name: "Putu Mayam",
        description: "Putu Mayam (also known as Idiyappam) is a light, sweet South Indian-inspired breakfast or snack, often enjoyed by vegetarians. It consists of fine rice flour noodles served cold with shredded coconut and brown palm sugar.",
        image: "/placeholder.svg?height=300&width=500"
      },
      {
        id: 24,
        name: "Popiah",
        description: "Popiah is a fresh spring roll made with a thin crepe-like skin and filled with a mix of shredded jicama, carrots, tofu, and lettuce. Vegetarian versions exclude meat and sometimes include mushrooms, bean curd, or glass noodles.",
        image: "/placeholder.svg?height=300&width=500"
      }
    ]
  },
  {
    id: "drinks",
    title: "Drinks",
    description: "Quench your thirst with Malaysia's refreshing and unique beverages.",
    items: [
      {
        id: 25,
        name: "Teh Tarik",
        description: "Teh Tarik is Malaysia's national drink, a frothy, creamy pulled milk tea made with strong black tea and condensed milk. The name means 'pulled tea,' referring to the dramatic pouring technique between two cups, which cools and aerates the drink, creating its signature foam.",
        image: "/placeholder.svg?height=300&width=500"
      },
      {
        id: 26,
        name: "Kopi",
        description: "Kopi is the traditional Malaysian-style black coffee, robust and often served sweet with condensed or evaporated milk. Brewed using a cloth coffee sock and dark roasted beans (sometimes with added margarine during roasting), it offers a bold, smoky flavor.",
        image: "/placeholder.svg?height=300&width=500"
      },
      {
        id: 27,
        name: "Air Mata Kucing",
        description: "Air Mata Kucing is a traditional Malaysian herbal drink made from dried longan, monk fruit (luo han guo), and winter melon. This naturally sweet, cooling drink is popular in hot weather for its refreshing taste and health benefits.",
        image: "/placeholder.svg?height=300&width=500"
      },
      {
        id: 28,
        name: "Sirap Bandung",
        description: "Sirap Bandung is a bright pink, sweet drink made with rose syrup and evaporated or condensed milk, creating a creamy, floral-flavored treat. Popular during festive seasons like Hari Raya and found at roadside drink stalls.",
        image: "/placeholder.svg?height=300&width=500"
      },
      {
        id: 29,
        name: "Milo Ais",
        description: "Milo Ais is Malaysia's beloved iced chocolate malt drink, made with Milo powder, condensed milk, and ice—perfectly sweet and energizing. Loved by kids and adults alike, it's commonly available at school canteens, mamak stalls, and kopitiams.",
        image: "/placeholder.svg?height=300&width=500"
      }
    ]
  },
  {
    id: "desserts",
    title: "Desserts",
    description: "Satisfy your sweet tooth with Malaysia's delightful desserts and sweet treats.",
    items: [
      {
        id: 30,
        name: "Marshmallow Ice Cream",
        description: "Marshmallow Ice Cream is a playful and indulgent treat that's gaining popularity in trendy cafes and dessert stalls across Malaysia. This creamy dessert combines soft, fluffy marshmallows with rich, milky ice cream, often topped with rainbow sprinkles, chocolate sauce, or crushed cookies.",
        image: "/placeholder.svg?height=300&width=500"
      },
      {
        id: 31,
        name: "Apam Balik",
        description: "Apam Balik is a beloved Malaysian street dessert—crispy on the outside and soft on the inside. This thick pancake is filled with a mix of crushed peanuts, sugar, and sweet corn, though modern versions include chocolate, banana, or Nutella.",
        image: "/placeholder.svg?height=300&width=500"
      },
      {
        id: 32,
        name: "Kek Lapis Sarawak",
        description: "Kek Lapis Sarawak is a vibrant layered cake native to Sarawak, East Malaysia. Known for its eye-catching colors and intricate patterns, this moist, rich cake is made with butter, eggs, and a blend of spices or fruit flavors.",
        image: "/placeholder.svg?height=300&width=500"
      },
      {
        id: 33,
        name: "Ais Kacang",
        description: "Ais Kacang (or ABC) is a colorful mountain of shaved ice topped with red beans, sweet corn, grass jelly, peanuts, and drizzled with syrup and condensed milk. Sometimes enriched with attap seeds or ice cream, it's one of Malaysia's most iconic desserts.",
        image: "/placeholder.svg?height=300&width=500"
      },
      {
        id: 34,
        name: "Kuih-Muih",
        description: "Kuih-Muih is a general term for the wide variety of bite-sized traditional Malaysian cakes and snacks, often made with rice flour, coconut milk, and palm sugar. Common types include Kuih Seri Muka, Kuih Lapis, and Ondeh-Ondeh.",
        image: "/placeholder.svg?height=300&width=500"
      },
      {
        id: 35,
        name: "Cendol",
        description: "Cendol is a refreshing iced dessert made with pandan-flavored green jelly noodles, coconut milk, palm sugar syrup (gula Melaka), and shaved ice. Often topped with red beans, glutinous rice, or even durian, Cendol is creamy, sweet, and slightly salty.",
        image: "/placeholder.svg?height=300&width=500"
      }
    ]
  },
  {
    id: "sides",
    title: "Sides",
    description: "Complement your main dishes with these delicious Malaysian side dishes.",
    items: [
      {
        id: 36,
        name: "Sambal Udang",
        description: "Sambal Udang is a spicy, flavorful Malaysian side dish made from prawns cooked in a rich sambal sauce. This dish combines the sweetness of fresh prawns with the heat of chili, garlic, tamarind, and belacan (fermented shrimp paste).",
        image: "/placeholder.svg?height=300&width=500"
      },
      {
        id: 37,
        name: "Lemang",
        description: "Lemang is a traditional Malay delicacy made of glutinous rice, coconut milk, and salt, cooked slowly in bamboo over an open fire. Often enjoyed during festive seasons like Hari Raya, Lemang has a smoky aroma and sticky texture.",
        image: "/placeholder.svg?height=300&width=500"
      },
      {
        id: 38,
        name: "Ayam Goreng",
        description: "Ayam Goreng, or Malaysian-style fried chicken, is a crunchy and juicy side dish commonly served with rice dishes. Marinated in turmeric, chili, garlic, and spices, the chicken is deep-fried to golden perfection.",
        image: "/placeholder.svg?height=300&width=500"
      },
      {
        id: 39,
        name: "Durian",
        description: "Durian is often called Malaysia's most controversial fruit, famously known as the 'King of Fruits'. Its strong aroma and custard-like texture spark passionate reactions—people either love it or loathe it.",
        image: "/placeholder.svg?height=300&width=500"
      }
    ]
  }
...
export const MALAYSIA_PLACES_TO_VISIT = [
  {
    ...
    otherInfo: {
      ...
      time_to_visit: "hot and humid year-round, May-July and November-February experience less rainfall",
      how_to_reach: "Flights are available to Kuala Lumpur International Airport",
  ...
  },
  {
    id: 10,
    name: "Ipoh",
    description: "Ipoh, the capital of Perak, is gaining popularity for its colonial charm, cave temples, and famous food scene. Stroll through Old Town's street art and heritage shophouses, then explore limestone caves like Kek Lok Tong. The city's blend of Cantonese roots and chill pace has won over travelers seeking food, stories, and calm beauty wrapped in history. Great for weekend getaways and cultural exploration.",
    image: "/placeholder.svg",
    otherInfo: {
      must_do: "Visit Kek Lok Tong Cave Temple, Try Ipoh white coffee and bean sprout chicken",
      time_to_visit: "All year round",
      how_to_reach: "2.5–3 hour drive from Kuala Lumpur or take the ETS train to Ipoh Railway Station"
    }
  },
  {
    id: 11,
    name: "Sipadan Island",
    description: "Sipadan Island is not only Malaysia's but also one of the world's top dive destinations, located off the coast of Sabah in Malaysian Borneo. Known for its crystal-clear waters and exceptional biodiversity, divers encounter turtles, reef sharks, barracudas, and swirling schools of fish. Access is limited daily to preserve its marine ecosystem, making each dive exclusive. Locals and marine authorities proudly protect Sipadan's pristine beauty. For those seeking an untouched, elite underwater experience, Sipadan is Malaysia's ultimate treasure.",
    image: "/placeholder.svg",
    otherInfo: {
      must_do: "Scuba dive with turtles and barracudas",
      time_to_visit: "April–October",
      how_to_reach: "Fly to Tawau Airport → Drive to Semporna → Boat to Sipadan, permit required"
    }
  },
  {
    id: 12,
    name: "Lankayan Island",
    description: "Lankayan Island is a secluded coral jewel in the Sulu Sea, perfect for divers and serenity seekers. Known for its turtle hatcheries and macro marine life, it offers a tranquil escape with only one eco-resort on the island. Mornings are for diving, afternoons for relaxing on powdery white sands, and evenings for watching baby turtles return to the sea. The island's tight-knit local staff and conservation efforts reflect its slow, thoughtful rhythm of life.",
    image: "/placeholder.svg",
    otherInfo: {
      must_do: "Dive at shipwrecks, Watch turtle hatchlings, Enjoy beach solitude",
  ...
  },
  {
    id: 13,
    name: "Johor Bahru (JB)",
    description: "Johor Bahru is a dynamic southern city that blends modern attractions with heritage charm. It's known for being the gateway to Singapore, Legoland Malaysia, lively street food, and royal palaces. Explore local Malay-Chinese eateries, stroll along Jalan Tan Hiok Nee, or catch a glimpse of history at Sultan Abu Bakar Mosque. The city's blend of cultures, shopping, and family-friendly fun makes it one of Malaysia's rising urban destinations.",
    image: "/placeholder.svg",
    otherInfo: {
      must_do: "Visit Legoland Malaysia, Explore Johor Bahru Old Chinese Temple",
      time_to_visit: "All year round",
      how_to_reach: "Fly to Senai International Airport or drive from Singapore via the Causeway",
      guide_text: "Optional",
      guide_link: null
    }
  },
...
`,
  ...
  complete_food_guide: {
    ...
    image: "/images/country/malaysia/places/kuala/kuala_lumpur.png",
    description: "A Complete Food Guide of what to eat in Malaysia",
    overview: "Malaysia's cuisine is a vibrant tapestry of flavors, influenced by its rich cultural heritage and abundant local ingredients. From street food stalls to high-end restaurants, the food scene offers something for every palate and budget. Here are some must-try dishes during your visit.",
    data: MALAYSIA_COMPLETE_FOOD_GUIDE,
    best_places: {
      penang: {
        title: "Penang – Best Places to Eat",
        description: "Penang is often called Malaysia's food capital, and for good reason. George Town's street food is legendary—try Char Kway Teow at Siam Road or Penang Assam Laksa at Air Itam Market. Visit Gurney Drive Hawker Centre for an all-in-one foodie experience.",
        image: "/placeholder.svg",
        highlights: [
      ...
      kuala_lumpur: {
        title: "Kuala Lumpur",
        description: "Kuala Lumpur is a food lover's paradise, offering everything from upscale dining to street food gems. Visit Jalan Alor for buzzing night market vibes and local favorites like satay and grilled seafood.",
        image: "/placeholder.svg",
        highlights: [
      ...
      langkawi: {
        ...
        description: "Langkawi's food scene blends beachside charm with local flavors. Cenang Beach is packed with seafood restaurants like Orkid Ria and The Cliff, offering fresh catches with ocean views.",
        image: "/placeholder.svg",
        highlights: [
