const ThankYouForReading = ({ name }: any) => {
  return (
    <div className="bg-gradient-to-br from-teal-50 to-blue-50 mt-12 py-6 px-4 sm:px-6 lg:px-8 text-center">
      <div className="animate-fade-in">
        ...
        <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
          We hope you found this guide helpful in planning your amazing trip to{" "}
          {name}. Safe travels and create unforgettable memories!
        </p>
...
export default ThankYouForReading;
