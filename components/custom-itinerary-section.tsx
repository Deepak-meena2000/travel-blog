...
const features = [
  {
    ...
    icon: "📝",
    description: "Get a travel plan tailored just for you, based on your interests and preferences.",
  ...
  },
  {
    title: "Free of Cost",
    icon: "🎁",
    description: "Enjoy our itinerary planning service completely free—no hidden charges!",
  ...
  },
  {
    ...
    icon: "🔍",
    description: "Benefit from thoroughly researched recommendations and local insights.",
  ...
  },
  {
    ...
    icon: "🌏",
    description: "Leverage our years of travel experience for a smoother, richer journey.",
