...
const features = [
  {
    ...
    icon: "🎯",
    description: "Plan your perfect day with our curated activities",
  ...
  },
  {
    ...
    icon: "🏨",
    description: "Find the perfect stay for your comfort",
  ...
  },
  {
    ...
    gradient: "bg-gradient-to-r from-orange-600/20 to-red-600/20",
  },
  {
    title: "Experiences",
    icon: "✨",
    description: "Add unique experiences to your journey",
